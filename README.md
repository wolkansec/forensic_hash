...
- `reportlab` yalnızca PDF raporu almak istediğinizde gerekir
...
- `.pdf`  : Stilize edilmiş PDF raporu

> Not: PDF raporu oluşturmak için `reportlab` paketinin yüklü olması gerekir.
...
Doğrulama raporu üretildiğinde baseline dosyası başarılı bir şekilde güncellenir.
...
- Çoklu algoritma seçerken hem boşluk hem de virgül kullanabilirsiniz.
- Baseline doğrulama için JSON dosyası her çalıştırmada güncellenir.
- PDF raporlarında uzun hash değerleri taşma yapmaması için satır içi kırma kullanılır.

## Lisans

Bu araç, adli bilişim ve bütünlük doğrulama amaçlıdır. Kendi kullanımınıza göre uyarlayabilirsiniz.
